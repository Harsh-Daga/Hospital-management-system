  ...
  <div id="content"> 
    ...
    <!-- DOCTOR LIST -->
    <section class="p-t-b-150" id="our-services">
      <div class="container"> 
        
        <!-- Heading -->
        <div class="heading-block">
          <h2 style="color:#FFB200;">Our Services</h2>
          <hr>
          <span style="color:#D2D79F;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span> </div>
