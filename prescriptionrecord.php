  ...
  <input type="hidden" name="prescriptionid" value="<?php echo $_GET['prescriptionid']; ?>"  />
    <table class="table table-striped">
      <tbody>
		...
		{
			echo "<option value='$rsmedicine[medicineid]'>$rsmedicine[medicinename] (Rs $rsmedicine[medicinecost] )</option>";
		}
		?>
		  </select>
		  </td>
    ...
    <table class="table table-hover table-striped">
      <tbody>
        ...
        echo "<tr>
          ...
          <td>&nbsp;₹$rs[cost]</td>
		   <td>&nbsp;$rs[unit]</td>
		   <td  align='right'>Rs" . $rs['cost'] * $rs['unit'] . "</td>";
			if(!isset($_SESSION['patientid']))
			{
        ...
        <tr>
		  ...
		  <th align="right">Rs <?php echo $gtotal; ?></th>
		  <td></td>
          </tr>
        <tr>
